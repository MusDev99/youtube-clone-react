	...
	return (
		<div className="header">
			<div className="header-left">
				<button className="bar-btn" onClick={() => setOpenBar(true)}>
					<i className="fas fa-bars"></i>
				</button>

				<img className="logo" src={require("../images/youtube.png")}></img>
			</div>
			...
			<div className="header-right">
				...
				<div className="upload">
					<button className="upload-btn">
						...
						<input type="file" id="actual-btn" hidden accept="video/*" />
					</button>
				</div>
			</div>
		</div>
